...
\begin{figure}[h]
    ...
    \node[box, below=0.8cm of conv2] (fc2) {Linear\\$\rightarrow$ 32};
    \node[box, right=of fc2] (output) {Linear\\$\rightarrow$ 2\\(sin $\theta$, cos $\theta$)};
    ...
    % % Add a note about the latent space
    % \node[below=0.4cm of fc2, align=center, text width=3.5cm, font=\footnotesize] 
    %     {Circular manifold emerges in 32D latent space};
